...
class Federico_Auth_Adapter_Doctrine implements Zend_Auth_Adapter_Interface
{
    ...
    {
        $this->_credential = crypt($credential, '$2a$07$ib3Ty0uw0n7cr4cKtH1ZmM$');
        return $this;
    }
    ...
    protected function _authenticateSetup()
    {
        ...
        if ($this->_em === null) {
            ...
            $exception = 'A entity name must be supplied for the Federico_Auth_Adapter_Doctrine authentication adapter.';
        } elseif ($this->_identityColumn == '') {
            $exception = 'An identity column must be supplied for the Federico_Auth_Adapter_Doctrine authentication adapter.';
        } elseif ($this->_credentialColumn == '') {
            $exception = 'A credential column must be supplied for the Federico_Auth_Adapter_Doctrine authentication adapter.';
        } elseif ($this->_identity == '') {
            $exception = 'A value for the identity was not provided prior to authentication with Federico_Auth_Adapter_Doctrine.';
        } elseif ($this->_credential === null) {
            $exception = 'A credential value was not provided prior to authentication with Federico_Auth_Adapter_Doctrine.';
        }
    ...
    protected function _validateResult($resultIdentities)
    {
        if (count($resultIdentities) < 1) {
            ...
            //var_dump($resultIdentity->getPassword());die;
